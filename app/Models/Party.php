...
class Party extends Model
{
    ...
    public function barShifts()      { return $this->hasMany(BarShift::class)->orderBy('sort_order')->orderBy('from'); }
    public function doorAssignments(){ return $this->hasMany(DoorAssignment::class)->orderBy('sort_order')->orderBy('from'); }
    ...
    public function balance(): float       { return $this->totalIncome() - $this->totalExpenses(); }
