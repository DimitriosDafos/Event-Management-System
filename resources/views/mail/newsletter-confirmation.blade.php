    ...
    <tr>
        <td align="center">
            <table width="580" cellpadding="0" cellspacing="0" style="max-width:580px; width:100%;">
                ...
                {{-- Header --}}
                <tr>
                    <td style="background:#0f0d0a; border-radius:10px 10px 0 0; padding:32px 40px; text-align:center;">
                ...
                <tr>
                    <td style="background:#ffffff; padding:40px 40px 32px;">
                        <p style="margin:0 0 16px; font-size:22px; font-weight:700; color:#1a1a1a;">
                            Willkommen{{ $subscriberName ? ', ' . $subscriberName : '' }}! 🎉
                        </p>
                        <p style="margin:0 0 20px; font-size:15px; color:#444; line-height:1.7;">
                            Vielen Dank für deine Anmeldung zu unserem Newsletter. 
                            Du wirst ab sofort über kommende Events, Line-Ups und besondere Ankündigungen informiert.
                        </p>
                        <p style="margin:0 0 20px; font-size:15px; color:#444; line-height:1.7;">
                            Wir versprechen: Kein Spam, nur das Wesentliche.
                        </p>
                        <table cellpadding="0" cellspacing="0" style="margin:28px 0;">
                            <tr>
                                <td style="background:#d4832a; border-radius:6px; padding:0;">
                                    <a href="{{ url('/') }}"
                        ...
                        <p style="margin:0; font-size:14px; color:#888; line-height:1.6;">
                            Falls du diese E-Mail irrtümlich erhalten hast oder dich abmelden möchtest,
                            antworte einfach auf diese E-Mail mit dem Betreff „Abmelden".
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="background:#f0ece8; border-radius:0 0 10px 10px; padding:20px 40px; text-align:center;">
                        <p style="margin:0; font-size:12px; color:#999; line-height:1.6;">
                            {{ \App\Models\Setting::get('footer_text', 'event-team · gemeinnützig') }}<br>
                            <a href="{{ url('/') }}" style="color:#d4832a; text-decoration:none;">
                                {{ url('/') }}
                            </a>
                        </p>
                    </td>
